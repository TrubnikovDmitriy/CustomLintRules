...
class ActivityResultDetector : Detector(), SourceCodeScanner {
    ...
    companion object {
        val ISSUE = Issue.create(
            ...
            "Result code comparing to request code",
            "Request code in onActivityResult should not be compared to result codes",
    ...
    override fun visitReference(
        ...
        // val anotherOperand =
        //     if (comparison.leftOperand.getQualifiedParentOrThis() == reference.getQualifiedParentOrThis()) {
        ...
        //         .build()
        //     context.report(
        //         ISSUE, context.getLocation(comparison),
        //         "`${paramRequestCode.name}` should not be compared to `${referenced.name}`",
        //         fix
        //     )
        // }
        context.report(
            ISSUE, context.getLocation(reference),
            "Test error"
        )
    }
